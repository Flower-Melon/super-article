...
runtime replanning, and presents the LLM-centered closed-loop decision framework
that implements this sequence. The task model represents aerial observations,
...
plans, corrective feedback, and prior experience among the system components,
