...
AirSim for testing whether high-level closed-loop decision making with the
LLM-centered closed-loop decision framework remains effective as operational
pressure increases. It instantiates the task model in
