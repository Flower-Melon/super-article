...
end-to-end behavior on the task defined in Section~3. Rather than reducing the
closed-loop rescue process to a single aggregated score, the evaluation reports
the six mission-level metrics in Table~\ref{tab:evaluation-metrics}. Together,
these metrics assess whether the system completes rescue objectives promptly,
uses fleet resources responsibly, and maintains coordinated operation when
conditions change.
