...
demonstrations are generated from scenarios disjoint from the 80 evaluation
...
overall scores. The leading configuration depends on scenario difficulty:
...
type and intensity of scenario pressure rather than following one fixed
...
losses in coordination and time efficiency as scenario pressure increases.
...
Increasing scenario difficulty nevertheless degrades every configuration.
The most pronounced changes occur in mission time and event stability: time
scores fall to 3.54--13.23 in expert scenarios, while event-stability scores
fall to 0--2.67. By contrast, expert-level completion remains above 90 for all
models. Thus, the principal challenge in the hardest scenarios is not whether
...
to 9.68 points in hard scenarios and 15.45 points in expert scenarios. This
...
from 59.03 to 35.86 in hard scenarios and from 37.55 to 12.98 in expert
scenarios. The sharp degradation confirms that an initially valid plan is
...
reductions of 70.3\% and 75.3\%, for simple and normal scenarios,
