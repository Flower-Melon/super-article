...
addition to addressing different stages of the decision chain, these methods
assume different inputs, outputs, resource models, and evaluation protocols.
Their reported results therefore provide references for individual
capabilities but do not constitute a directly comparable end-to-end numerical
baseline for the task studied here. In contrast, this work treats wildfire
rescue as a closed-loop decision problem from aerial observation to structured
fire-situation understanding, resource-constrained multi-UAV planning,
validation, and local runtime replanning. This formulation connects the outputs
of perception to executable team actions and preserves mission continuity
