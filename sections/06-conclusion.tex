...
Three sets of evidence support this conclusion. First, the complete framework
maintains high basic task completion across four downstream foundation-model
configurations, showing that end-to-end operation is not confined to one
downstream model, although all configurations lose execution quality under
greater operational pressure. Second, the ablations show condition-dependent
